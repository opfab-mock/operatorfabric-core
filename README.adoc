...
image:https://travis-ci.org/opfab-mock/operatorfabric-core.svg?branch=develop[Build
...
image:https://sonarcloud.io/api/project_badges/measure?project=org.lfenergy.operatorfabric%3Aoperatorfabric-core-mock&metric=coverage[Coverage,link=https://sonarcloud.io/component_measures?id=org.lfenergy.operatorfabric%3Aoperatorfabric-core&metric=Coverage]
...
image:https://img.shields.io/website-up-down-green-red/http/opfab-mock.github.io.svg[Website
opfab-mock.github.io,link=http://opfab-mock.github.io/]
...
+
----
./src/main/docker/deploy/docker-compose.sh
----
